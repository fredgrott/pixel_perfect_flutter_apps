...
//
// Soft fork of Material.io team's adaptive breakpoints
// which is under BSD license copyrigth 2020, see:
// https://github.com/material-components/material-components-flutter-adaptive/blob/develop/adaptive_breakpoints/lib/src/adaptive_breakpoints.dart
...
/// Adjusted to MD3 breakpoints, see
...
BreakpointSystemEntry getBreakpointEntry(BuildContext context) {
  ...
  for (final BreakpointSystemEntry entry in breakpointSystem) {
