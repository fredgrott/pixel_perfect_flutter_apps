...
import 'package:mdthree_breakpoints/internal/adaptive_breakpoints.dart';
...
class AdaptiveContainer extends StatelessWidget {
  ...
  AdaptiveContainer({
    ...
    AdaptiveConstraints constraints = const AdaptiveConstraints(),
    this.columnSpan = 1,
        ...
        assert(
            ...
            constraints = constraints  ?? const AdaptiveConstraints();
...
class AdaptiveConstraints {
  ...
  bool withinAdaptiveConstraint(BuildContext context) {
    final AdaptiveWindowType currentEntry = getWindowType(context);
