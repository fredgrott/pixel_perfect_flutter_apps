...
import 'package:fredgrotts_md3_demo/src/presentation/custom_animated_theme/circular_animation/circular_animated_theme.dart';
import 'package:fredgrotts_md3_demo/src/presentation/custom_animated_theme/fade/fade_animation_theme.dart';
import 'package:fredgrotts_md3_demo/src/presentation/custom_animated_theme/scale/scale_animated_theme.dart';
...
class CustomAnimatedThemeApp extends StatefulWidget {
  ...
  const CustomAnimatedThemeApp({
    ...
    this.animationType = AnimationType.fadeAnimatedTheme,
  ...
  const CustomAnimatedThemeApp.router({
    super.key,
    this.scaffoldMessengerKey,
...
class _MaterialAppState extends State<CustomAnimatedThemeApp> {
  ...
  Widget _materialBuilder(BuildContext context, Widget? child,) {
    ...
    switch (widget.animationType) {
      case AnimationType.fadeAnimatedTheme:
      case AnimationType.scaleAnimatedTheme:
        ...
        break;
      case AnimationType.circularAnimatedTheme:
        if (widget.darkTheme != null) {
          final ui.Brightness platformBrightness =
              MediaQuery.platformBrightnessOf(context);
          if (mode == ThemeMode.dark ||
