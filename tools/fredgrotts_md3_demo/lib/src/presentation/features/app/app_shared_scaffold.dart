            ...
            config: {
              ...
              Breakpoints.medium: SlotLayout.from(
                ...
                builder: (_) => AdaptiveScaffold.standardNavigationRail(
                  ...
                  selectedIconTheme: Theme.of(context).navigationRailTheme.selectedIconTheme as IconThemeData,
                  unselectedIconTheme: Theme.of(context).navigationRailTheme.unselectedIconTheme as IconThemeData,
                  selectedLabelTextStyle: Theme.of(context).navigationRailTheme.selectedLabelTextStyle as TextStyle,
                ),
              ),
